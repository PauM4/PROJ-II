#ifndef __W3_SCENE_MAZE_H__
#define __W3_SCENE_MAZE_H__
...
class W3_Scene_Maze : public Module
{
public:

	W3_Scene_Maze(bool isActive);

	// Destructor
	virtual ~W3_Scene_Maze();
